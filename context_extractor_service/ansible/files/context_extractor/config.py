...
LANG_NODESETS: dict[str, LangNodeset] = {
    ...
    "java": {
        ...
        "call": {"method_invocation", "method_reference"},
        "control": {
    ...
    "python": {
        ...
        "key": {
            ...
            # match/case and exception binding lines need statement-level treatment
            "case_clause", "except_clause", "except_group_clause",
        },
        "ident": {"identifier"},
        "runtime_ident": {"identifier"},
        "member_like": {"attribute"},
        "assign": {"assignment", "augmented_assignment", "named_expression"},
        "declaration": set(),
        "call": {"call"},
        "loop": {"for_statement"},
    ...
    "typescript": {
        ...
        "call": {"call_expression", "jsx_self_closing_element"},
    ...
    "go": {
        ...
        "key": {"short_var_declaration", "assignment_statement", "call_expression",
                "if_statement", "return_statement", "for_statement", "var_declaration"},
        "ident": {"identifier"},
        "runtime_ident": {"identifier"},
    ...
    "kotlin": {
        ...
        "block": {"block", "function_declaration", "lambda_literal"},
        "key": {"assignment", "call_expression", "if_expression", "return_expression", "for_statement",
                "while_statement"},
        "ident": {"identifier", "simple_identifier"},
        "runtime_ident": {"identifier", "simple_identifier"},
    ...
    "php": {
        ...
        "call": {"function_call_expression", "method_call_expression", "member_call_expression", "scoped_call_expression"},
    ...
    "bash": {
        ...
        "key": {"variable_assignment", "command", "redirected_statement", "if_statement", "pipeline"},
