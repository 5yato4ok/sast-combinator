...
codeql database create "$DB_DIR" --language="javascript-typescript" --source-root "$INPUT_DIR" --verbosity="${LOG_LEVEL}" -j "${JOBS}"

QPKG="codeql/javascript-queries:codeql-suites/javascript-security-extended.qls"
